                ...
                <section className="team-section pt-space pb-space">
                    <div className="container">
                        <div className="row g-xxl-7 g-xl-5 g-lg-4 g-3">
                            <Tilt options={toltOptions} className="col-xl-4 col-lg-4 col-md-6 col-sm-6" data-aos="zoom-in-left" data-aos-duration={1400}>
                                <div className="team-common-item tilt">
                                    <div className="thumb position-relative overflow-hidden w-100">
                                        <img src="/assets/img/team/Sanjay-Singh.jpg" alt="img" className="overflow-hidden w-100" />
                            ...
                            <Tilt options={toltOptions} className="col-xl-4 col-lg-4 col-md-6 col-sm-6" data-aos="zoom-in-left" data-aos-duration={1600}>
                                <div className="team-common-item tilt">
                                    <div className="thumb position-relative overflow-hidden w-100">
                                        <img src="/assets/img/team/Ayyapa-Raju.jpg" alt="img" className="overflow-hidden w-100" />
                                        <div className="namebox py-xxl-5 py-xl-4 py-sm-3 py-2 px-3 text-center">
                                            <span className="text-capitalize white-clr d-block mb-2">
                                                Co-Founder, India Center Head
                                            </span>
                                            <h5>
                                                <Link href="/team-details" className="htheme white-clr">
                                                    Ayyapa Raju
                            ...
                            <Tilt options={toltOptions} className="col-xl-4 col-lg-4 col-md-6 col-sm-6" data-aos="zoom-in-left" data-aos-duration={1700}>
                                <div className="team-common-item tilt">
                                    <div className="thumb position-relative overflow-hidden w-100">
                                        <img src="/assets/img/team/Abhishek-Gangwar.jpg" alt="img" className="overflow-hidden w-100" />
                                        <div className="namebox py-xxl-5 py-xl-4 py-sm-3 py-2 px-3 text-center">
                                            <span className="text-capitalize white-clr d-block mb-2">
                            ...
                            <Tilt options={toltOptions} className="col-xl-4 col-lg-4 col-md-6 col-sm-6" data-aos="zoom-in-left" data-aos-duration={1800}>
                                <div className="team-common-item tilt">
                                    <div className="thumb position-relative overflow-hidden w-100">
                                        <img src="/assets/img/team/Sudhish-Jugran.jpg" alt="img" className="overflow-hidden w-100" />
                                        <div className="namebox py-xxl-5 py-xl-4 py-sm-3 py-2 px-3 text-center">
                                            <span className="text-capitalize white-clr d-block mb-2">
                            ...
                            <Tilt options={toltOptions} className="col-xl-4 col-lg-4 col-md-6 col-sm-6" data-aos="zoom-in-left" data-aos-duration={1900}>
                                <div className="team-common-item tilt">
                                    <div className="thumb position-relative overflow-hidden w-100">
                                        <img src="/assets/img/team/Prakash-Kumar.jpg" alt="img" className="overflow-hidden w-100" />
                                        <div className="namebox py-xxl-5 py-xl-4 py-sm-3 py-2 px-3 text-center">
                                            <span className="text-capitalize white-clr d-block mb-2">
                            ...
                            <Tilt options={toltOptions} className="col-xl-4 col-lg-4 col-md-6 col-sm-6" data-aos="zoom-in-left" data-aos-duration={2000}>
                                <div className="team-common-item tilt">
                                    <div className="thumb position-relative overflow-hidden w-100">
                                        <img src="/assets/img/team/Saroj-Patro.jpg" alt="img" className="overflow-hidden w-100" />
                                        <div className="namebox py-xxl-5 py-xl-4 py-sm-3 py-2 px-3 text-center">
                                            <span className="text-capitalize white-clr d-block mb-2">
